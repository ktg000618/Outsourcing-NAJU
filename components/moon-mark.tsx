...
export function MoonMark({
  ...
  // 되돌아오는 호가 어느 쪽으로 도는지가 곧 차오름/기욺이다.
  // 0.5 미만이면 오른쪽(밝은 쪽)으로 되돌아와 초승달, 이상이면 왼쪽으로 돌아 차오른 달.
  // ⚠️ 처음엔 이 플래그가 반대로 들어가 0.1 이 90% 찬 달로 그려졌다 — 연표가
  // "차오르는 달"이 아니라 "기우는 달"이었고 아무도 눈치 못 챘다. 실제 렌더로 검증할 것.
